...
procedure TFormsatu.Button1Click(Sender: TObject);
var
    nil1,nil2,nil3,nil4, hasil : real ;
    b1,b2,b3 : real;
    grade : string;
begin
...
procedure TFormsatu.Button2Click(Sender: TObject);
begin
  editnilai1.Text := '0';
  editnilai2.Text := '0';
  editnilai3.Text := '0';
...
procedure TFormsatu.Button3Click(Sender: TObject);
begin
